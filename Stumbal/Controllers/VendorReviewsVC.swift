...
import Alamofire
import Kingfisher
class VendorReviewsVC: UIViewController,UITableViewDataSource,UITableViewDelegate {

@IBOutlet var vendortblView: UITableView!
            ...
            else
            {
                do  {
                    ...
                    if self.AppendArr.count != 0 {
                        ...
                        self.vendortblView.isHidden = false
                        ...
                        self.vendortblView.isHidden = true
...
func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    let cell =  vendortblView.dequeueReusableCell(withIdentifier: "ReviewsTblCell", for: indexPath) as! ReviewsTblCell
