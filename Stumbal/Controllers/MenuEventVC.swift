...
import Kingfisher
import CoreLocation
class MenuEventVC: UIViewController,UITableViewDataSource,UITableViewDelegate,CLLocationManagerDelegate {

    @IBOutlet var eventTbleView: UITableView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        eventTbleView.dataSource = self
        eventTbleView.delegate = self
...
//            hud.label.text = "Loading...."
                 ...
                 else
                 {
                     do  {
                         ...
                         if self.AppendArr.count != 0 {
                             self.eventTbleView.isHidden = false
                            self.statusLbl.isHidden = true
                             self.eventTbleView.reloadData()
                            
                             MBProgressHUD.hide(for: self.view, animated: true)
                         }
                             
                         else  {
                           self.eventTbleView.isHidden = true
     ...
     //MARK: tableView Methode
       ...
       func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
           let cell =  eventTbleView.dequeueReusableCell(withIdentifier: "EventTblCell", for: indexPath) as! EventTblCell
