...
import EventKit
import EventKitUI
class EventDetailVC: UIViewController,CLLocationManagerDelegate,UICollectionViewDataSource,UICollectionViewDelegate {
...
@IBOutlet var collectionHeight: UICollectionView!
