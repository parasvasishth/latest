//
//  InviteEventDetailVC.swift
//  Stumbal
//
//  Created by Dr.Mac on 10/02/22.
//
...
import EventKitUI
import CoreLocation
class InviteEventDetailVC: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,CLLocationManagerDelegate {
    ...
    @IBOutlet weak var inviteBuyView: UIView!
    @IBOutlet weak var backObj: UIButton!
    @IBOutlet weak var threeDotObj: UIButton!
   ...
   // var hud = MBProgressHUD()
    override func viewDidLoad() {
       ...
       // dateLbl.text = UserDefaults.standard.value(forKey: "e_time") as! String
        ...
        let n:String = UserDefaults.standard.value(forKey: "Event_username") as! String
        
        nameLbl.text  = n + " has invited you to this event."
...
//        self.present(nextViewController, animated:false, completion:nil)
    ...
    @IBAction func bookbuy(_ sender: UIButton) {
//        let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
//        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "BuyTicketVC") as! BuyTicketVC
//        nextViewController.modalPresentationStyle = .fullScreen
//        self.present(nextViewController, animated:false, completion:nil)
...
//                self.present(signuCon, animated: false, completion:nil)
    ...
    func user_refund_request()
    {
        ...
        Alamofire.request("https://stumbal.com/process.php?action=user_refund_request", method: .post,parameters: ["user_id":UserDefaults.standard.value(forKey: "u_Id") as! String,"event_id":UserDefaults.standard.value(forKey: "Event_id") as! String],encoding:  URLEncoding.httpBody).responseJSON{ response in
    ...
    func delete_friend_invitation_event()
    {
        ...
        Alamofire.request("https://stumbal.com/process.php?action=delete_friend_invitation_event", method: .post,parameters: ["auto_id":UserDefaults.standard.value(forKey: "Event_autoid") as! String,"user_id":UserDefaults.standard.value(forKey: "Event_usernameid") as! String],encoding:  URLEncoding.httpBody).responseJSON{ response in
            if let data = response.data
            {
                let json = String(data: data, encoding: String.Encoding.utf8)
                print("=====1======")
                ...
                else
                {
                    ...
                    
                    {
                        ...
                        if  result == "success"
                        {
                            self.inviteBuyView.isHidden = true
            ...
            if let data = response.data
            {
                ...
                else
                {
                        ...
                        
                    {
                        ...
                        var result:String = json["result"] as! String
...
extension InviteEventDetailVC: EKEventEditViewDelegate {
...
extension InviteEventDetailVC:MKMapViewDelegate
{
