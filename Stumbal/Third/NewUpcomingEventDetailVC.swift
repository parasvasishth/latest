//
//  NewUpcomingEventDetailVC.swift
//  Stumbal
//
//  Created by Dr.Mac on 05/02/22.
//
...
class NewUpcomingEventDetailVC: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,CLLocationManagerDelegate {
            ...
            if let data = response.data
            {
                ...
                else
                {
                        ...
                        
                    {
                        ...
                        {
                            self.threeDotObj.isHidden = false
...
extension NewUpcomingEventDetailVC: EKEventEditViewDelegate {
...
extension NewUpcomingEventDetailVC:MKMapViewDelegate
{
